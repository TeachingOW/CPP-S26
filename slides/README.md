...
1. Start with `cpp-part1.pptx` for fundamentals
2. Progress to `cpp-part2.pptx` for advanced topics
...
See [SLIDE_UPDATES.md](./SLIDE_UPDATES.md) for detailed recommendations.
